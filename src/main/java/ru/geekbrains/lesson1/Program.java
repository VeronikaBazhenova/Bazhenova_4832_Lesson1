...
public class Program {
    ...
    public static void main(String[] args) {
        ...
        //------------------------//
        Chocolate choco1 = new Chocolate("Ritter", "Walnut", 220, 1200);
        Chocolate choco2 = new Chocolate("Aлёнка", "Классическая", 120, 1110);
        Chocolate choco3 = new Chocolate("Alpen Gold", "Strawbery", 180, 1250);
        products.add(choco1);
        products.add(choco2);
        products.add(choco3);
        VendingMachine vendingMachine2 = new VendingMachine(products);
        Chocolate chocolate = vendingMachine2.getChocolate(1200, "Ritter");
